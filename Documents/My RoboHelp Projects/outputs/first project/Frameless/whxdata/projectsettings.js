...
rh.consts('HELP_ID', '238a5d65-614f-4a99-be1a-c6e61cc0de8c' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "first project");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "Studio-NEW");
